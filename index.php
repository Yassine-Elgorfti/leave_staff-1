...
<head>
	...
	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="vendors/images/banque_populaire_logo.png">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/banque_populaire_logo.png">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/banque_populaire_logo.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<img src="vendors/images/banque_populaire.jpg" alt="New logo" width ="130" height = "70">
				</a>
			</div>
		</div>
	</div>
